...
function Hero() {
    return <>
        <div className="flex flex-col justify-center items-center gap-10 mt-10">
            ...
            >
                <motion.p
                    className=" px-7 py-1.5 text-primary text-center bg-primary/20 rounded-full hover:cursor-pointer"
                    animate={{
                        y: [0, -5, 0],
                        transition: {
                            repeat: Infinity,
            ...
            >
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button className="h-14 border border-primary bg-primary flex flex-row gap-2 px-8 py-3 rounded-lg shadow-lg shadow-primary/50 transition-all text-white hover:cursor-pointer" > <Link to={"/login"}> Start for free  </Link> <span> <ArrowRight size={25} className="text-white" /> </span> </Button>
                </motion.div>
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button className="border border-secondary bg-secondary  gap-2 px-8 py-3 rounded-lg text-white ml-4 hover:cursor-pointer" >Book a demo </Button>
                </motion.div>
            </motion.div>

            <motion.div
                className="shadow-primary/20 p-20"
